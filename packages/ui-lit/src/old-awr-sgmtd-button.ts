...
@customElement('old-m3-segmented-button')
export class OldAwrSgmtdButton extends LitElement {
  @property({ type: String })
  declare selected: string;
  
  @property({ type: Array })
  declare disabledOptions: string[];
...
declare global {
  interface HTMLElementTagNameMap {
    'old-m3-segmented-button': OldAwrSgmtdButton;
  }
}